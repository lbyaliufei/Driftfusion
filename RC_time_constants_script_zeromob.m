...
soleq.epp20.ion.par.mue(3) = 0;
soleq.epp20.ion.par.muh(3) = 0;
soleq.epp20.ion.par.dev = pc.builddev(soleq.epp20.ion.par);

soleq.epp30.ion.par.mue(3) = 0;
soleq.epp30.ion.par.muh(3) = 0;
soleq.epp30.ion.par.dev = pc.builddev(soleq.epp30.ion.par);         
...
fit_epp10 = fit(sol_relax.epp10.t(10:110)',log(Jepp10.c(10:110, pmid)),'poly1');
figure;plot(fit_epp10,sol_relax.epp10.t,log(Jepp10.c(:,pmid)));

Jepp20 = dfana.calcJ(sol_relax.epp20);

fit_epp20 = fit(sol_relax.epp20.t(10:110)',log(Jepp20.c(10:110, pmid)),'poly1');
figure;plot(fit_epp20,sol_relax.epp20.t,log(Jepp20.c(:,pmid)));

Jepp30 = dfana.calcJ(sol_relax.epp30);

fit_epp30 = fit(sol_relax.epp30.t(10:110)',log(Jepp30.c(10:110, pmid)),'poly1');
